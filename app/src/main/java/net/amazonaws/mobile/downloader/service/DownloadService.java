package net.amazonaws.mobile.downloader.service;
...
import net.amazonaws.mobile.downloader.query.DownloadQueueProvider;
import net.amazonaws.mobile.downloader.query.QueryHelper;
import net.amazonaws.mobile.downloader.request.DownloadAddRequest;
import net.amazonaws.mobile.downloader.request.DownloadRemoveRequest;
