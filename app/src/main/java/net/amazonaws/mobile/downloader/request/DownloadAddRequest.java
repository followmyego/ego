package net.amazonaws.mobile.downloader.request;
...
import net.amazonaws.mobile.downloader.service.DownloadFlags;
import net.amazonaws.mobile.downloader.service.DownloadService;
